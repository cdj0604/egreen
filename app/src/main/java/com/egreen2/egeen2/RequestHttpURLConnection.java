...
public class RequestHttpURLConnection {
    ...
    public String request(String _url, ContentValues _params) {
        ...
        /**
         *  2. HttpURLConnetion을 통해 web의 데이터를 가져옴
         */
        ...
        try {
            ...
            urlConn.setRequestProperty("Accept-Charset", "UTF-8");  // Accept-Charset설정
